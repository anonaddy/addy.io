    ...
    <body class="{{ $page->isActive('/') ? 'gradient text-white' : 'flex flex-col justify-between min-h-screen bg-white text-grey-800' }} leading-normal font-sans">
        @if($page->isActive('/'))
            ...
            <div class="product-hunt">
                ...
                @if($_GET['ref'] == 'producthunt')
                    <div class="text-white text-left text-sm md:text-base tracking-wide leading-tight mr-16 md:mr-0">
                        Hey Product Hunt! Remember you can get 50% off your first year with coupon code <span class="block md:inline-block font-semibold">PRODUCTHUNT50</span>
                    </div>
                @else
