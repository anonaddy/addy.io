...
ogtype: article
image: https://addy.io/assets/img/help/aliases/sort-filter-web.png
section: content
title: Sorting and filtering your aliases
date: 2026-05-26
description: How to sort and filter your addy.io aliases on the web, in the mobile app, and in the browser extension. Find aliases by search, status, or domain.
...
3. **Filter** - Use filter options to narrow the list, for example:
   - **Active / Inactive / Deleted** - Show only active aliases, only deactivated ones, deleted or all.
   - **Pinned** - Show only aliases that have been pinned.
4. **Sort** - Click the "Sort By" options at the top of the table (shown below in the red box) to sort by that value. Click the icon indicated by the red arrow below to change the sort direction to ascending/descending.
...
3. Use **filter** options on the alias list, use the **custom** filter to create your own filter.
...
3. The extension has a "Show:" dropdown option allowing you to view "All", "Active", "Deleted" etc.
4. You can also change the default sort by and direction in the extension settings.

The extension is best for quick lookup and [generating](/help/creating-new-email-aliases/) or [deactivating](/help/deactivating-email-aliases/) an alias; for managing many aliases, the web or mobile app is usually easier.
