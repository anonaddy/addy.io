...
<h2 id="check-the-applied-column">Check the Applied column</h2>
...
<h2 id="inferring-from-what-happened-to-the-email">Inferring from what happened to the email</h2>
...
- **Message went to a different recipient** - If the email was forwarded to an address you did not expect, a rule with a **forward to** action may have matched.
