...
ogtype: article
image: https://addy.io/assets/img/help/blocklist/delete-blocklist-entry.png
section: content
title: Deleting an entry from your blocklist
date: 2026-05-27
description: How to delete an email address or domain from your addy.io blocklist so it can send messages to your aliases again.
...
3. Click **Delete** for that entry (as shown by the red box below). You can also select multiple entries by clicking the checkbox as indicated by the red arrow below.
...
- If unwanted mail returns later, you can [add the sender again](/help/adding-an-entry-to-your-blocklist/).
