...
ogtype: article
image: https://addy.io/assets/img/help/getting-started/register-an-account-addy-io.png
section: content
title: Creating an account
date: 2026-04-24
description: How to create an addy.io account, choose a private username, verify your email address, and secure your account with a strong password and 2FA.
helpCategories: [getting-started]
order: 2
---

Creating an addy.io account only takes a few minutes. You will choose a username, verify your email address, and set a strong password before you can start creating aliases. This article walks through each step in plain language so you can get set up quickly and securely.
...
Please make sure that you understand these prohibited actions and that you have read the [terms of service](/terms) too in order to avoid your account being disabled for breaking them.

<div class="flex justify-center">
  <img class="shadow w-[750px] max-w-full h-auto" src="/assets/img/help/getting-started/prohibited-actions.png" alt="Prohibited actions" title="Prohibited actions">
</div>
