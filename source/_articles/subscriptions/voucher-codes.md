...
ogtype: article
image: https://addy.io/assets/img/help/subscriptions/voucher-codes.png
section: content
title: Purchasing and redeeming a voucher code
date: 2026-05-27
description: How voucher codes work on addy.io. Purchase or redeem a voucher to upgrade or extend your subscription. Buy on the subscription page or from official resellers.
...
A voucher code **is different from a coupon code**. Coupon codes provide a discount on a purchase and do not redeem a subscription like voucher codes do. If you have a coupon code you can enter it when redirected to Stripe to complete payment, or if paying with crypto by clicking "Have a coupon code? Click here" above the "Proceed To Cryptocurrency Payment" button.

To **purchase** a voucher code, go to the [subscription page](https://app.addy.io/settings/subscription), scroll to the **Voucher codes** section, select the quantity and plan (e.g. Lite or Pro), and complete payment.
...
1. Go to the [subscription page](https://app.addy.io/settings/subscription) and scroll to the **Voucher codes** section.
