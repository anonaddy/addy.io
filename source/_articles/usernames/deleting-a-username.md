...
ogtype: article
image: https://addy.io/assets/img/help/usernames/delete-username.png
section: content
title: Deleting a username
date: 2026-05-27
description: How to delete an additional username from your addy.io account. What happens to its aliases and what to do before you delete.
...
3. Confirm by clicking **Delete username**. The username and its aliases are removed from your account.

<div class="flex justify-center my-8">
  <img class="shadow max-w-full h-auto" src="/assets/img/help/usernames/delete-username.png" alt="Delete username option in addy.io" title="Deleting a username">
</div>

You cannot restore a deleted username or its aliases. If you only want to stop logging in with a username but keep it for aliases, use [Setting whether a username can be used to login](/help/setting-whether-a-username-can-be-used-to-login-to-your-account/) and turn **Can Be Used To Login** off instead of deleting.
