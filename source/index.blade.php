...
<section class="container flex flex-col items-center py-6">
	...
	<h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">Get started for FREE</h1>
	<div class="w-full mb-4">
		<div class="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
	</div>

	<a href="https://app.anonaddy.com/register" class="bg-white cursor-pointer text-indigo-500 font-bold rounded-full py-4 px-8 shadow">Choose Username</a>

	<p class="mt-12 mb-3 text-sm">Sign up for our newsletter</p>
