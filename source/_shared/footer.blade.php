<!--Footer-->
<footer class="gradient" role="contentinfo">
	<div class="container mx-auto px-8">
        ...
        <div class="w-full flex flex-row flex-wrap justify-between py-6">
            ...
            <div class="flex items-center mx-4 my-4 md:my-0">
                ...
                <a href="https://twitter.com/anonaddy" target="_blank" rel="nofollow noreferrer noopener" class="no-underline text-white" title="AnonAddy Twitter">
